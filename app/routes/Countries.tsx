...
// getting data through ComponentProps
export default function Countries({ loaderData }: Route.ComponentProps) {
  const [search, setSearch] = useState<string>("");
  const [region, setRegion] = useState<string>("");


  //Variables that deppend on loaderData
  ...
  return (
    <div className="p-6">
      ...
      {filteredCountries.length === 0 ? (
        <div> No countries match your filters. </div> //If user  enters name that doesnt match any country returns the div
      ) : (
